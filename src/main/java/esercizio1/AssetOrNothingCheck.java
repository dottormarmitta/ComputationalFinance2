...
public class AssetOrNothingCheck {
	...
	public static void main(String[] args) throws CalculationException {
		...
		final double T = 1.0;
		final int numberOfSimulation = 1000000;
		...
		// PercentaceError:
		double absolutePercentageError = (Math.abs((1/stock0)*value - delta)/delta)*100;
		System.out.println("Percentage error:  " + absolutePercentageError);
